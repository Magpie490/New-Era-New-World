...
NDiplomacy = {
	...
	MAX_DIPLO_DISTANCE = 550,									-- Most diplomacy is disallowed if two rulers are too distant
...
NCharacter = {
	...
	MAX_CHILD_BIRTH_AGE = 42,						-- Female menopause age.
	CHILD_BIRTH_TO_PREGNANCY_WAIT = 8,
	BASE_NR_OF_CHILDREN_PER_COUPLE = 2,
	EXTRA_NR_OF_CHILDREN_FOR_PLAYERS = 2,
	COURT_SIZE_CHILD_PENALTY_THRESHOLD = 10,
	...
	NATURAL_DEATH_CHANCE_AGE_0 = 180,				-- Natural deaths per decade out of 10000 people: Age 0-9
	NATURAL_DEATH_CHANCE_AGE_10 = 30,				-- Natural deaths per decade out of 10000 people: Age 10-19
	NATURAL_DEATH_CHANCE_AGE_20 = 30,				-- Natural deaths per decade out of 10000 people: Age 20-29
	NATURAL_DEATH_CHANCE_AGE_30 = 30,				-- Natural deaths per decade out of 10000 people: Age 30-39
	NATURAL_DEATH_CHANCE_AGE_40 = 41,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 140,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 1200,				-- Natural deaths per decade out of 10000 people: Age 60-69
	NATURAL_DEATH_CHANCE_AGE_70 = 4500,				-- Natural deaths per decade out of 10000 people: Age 70-79
	NATURAL_DEATH_CHANCE_AGE_80 = 5500,				-- Natural deaths per decade out of 10000 people: Age 80-90
	NATURAL_DEATH_CHANCE_AGE_90 = 9500,				-- Natural deaths per decade out of 10000 people: Age 90-99
	NATURAL_DEATH_CHANCE_AGE_100 = 9500,			-- Natural deaths per decade out of 10000 people: Age 100+
	...
	NOT_SPOUSE_FERTILITY_MULT = 0.1,				-- Applied to fertility when two lovers are not married
	MARRIED_LOVERS_FERTILITY_MULT = 1.1,			-- Applied to fertility when lovers are married
	INFANT_DEATH_CHANCE = 0,						-- Chance of stillbirth / death at birth
	...
	FEMALE_ATTRACTION_CUTOFF = 55,					-- After this age, the sex appeal of traits no longer have any effect
...
NReligion = {
	...
	ELECTOR_TITLE_CULTURE_GROUP_FACTOR = 5,
...
NEconomy = {
	...
	LOOT_EVERY_X_DAYS = 9,							-- Loot every this many days
...
NMilitary = {
	...
	ATTACKER_SIEGE_DAMAGE = 0.38,						-- damage done to attackers by defenders when not sallying
	...
	REINFORCE_RATE = 0.06,							-- Reinforce rate per year
...
NEngine = {
	EVENT_PROCESS_OFFSET = 240, 	 -- Events are checked every X day per character or province (1 is ideal, but CPU heavy). Max value of 255
	...
	PRUNE_MINIMAL_AGE = 16,				-- Minimum age for a courtier to be prunable if considered irrelevant
	HEALTH_IMMUNITY_TO_PRUNING = 8,		-- If a character has that much health, they won't be pruned
},
