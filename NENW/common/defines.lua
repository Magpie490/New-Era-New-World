...
NMilitary = {
	...
	ATTACKER_SIEGE_DAMAGE = 0.0,						-- damage done to attackers by defenders when not sallying
	DEFENDER_SIEGE_DAMAGE = 0.0,						-- damage done to defenders by attackers when not sallying
...
NEngine = {
	...
	PRUNE_MINIMAL_AGE = 18,				-- Minimum age for a courtier to be prunable if considered irrelevant
